...
void SIL9136_SetCSC(WORD val)
{
	...
	switch(val)	{
		...
		case 1:	out_mode = BITS_OUT_YCBCR444;	csc = BIT_BT_709;	Y=1;	break;	// YC444(bt709)
		case 2:	out_mode = BITS_OUT_YCBCR422;	csc = BIT_BT_709;	Y=1;	break;	// YC422(bt709)
		case 3: out_mode = BITS_OUT_RGB;		csc = BIT_BT_601;	Y=0;	break;	// RGB444(bt601)
		case 4:	out_mode = BITS_OUT_YCBCR444;	csc = BIT_BT_601;	Y=1;	break;	// YC444(bt601)
		case 5:	out_mode = BITS_OUT_YCBCR422;	csc = BIT_BT_601;	Y=1;	break;	// YC422(bt601)
...
//		case MISP_VIDOUT_1440x480i60:   VIC=  7;  break;  // 6 for 4:3
//		case MISP_VIDOUT_1440x576i50:   VIC= 22;  break;  // 21 for 4:3
